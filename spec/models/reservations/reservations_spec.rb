...
RSpec.describe Reservation, type: :model do
  describe '#valid?' do
    ...
    it 'returns false when checkin date is empty' do
      # Arrange
      user = User.create!(email: 'exemplo@mail.com', password: 'password')
    ...
    it 'returns false when checkout date is empty' do
      # Arrange
      user = User.create!(email: 'exemplo@mail.com', password: 'password')
    ...
    it 'returns false when guest_count is empty' do
      # Arrange
      user = User.create!(email: 'exemplo@mail.com', password: 'password')
    ...
    it 'returns false when stay_total is empty' do
      # Arrange
      user = User.create!(email: 'exemplo@mail.com', password: 'password')
    ...
    it 'returns true with all parameters present' do
      # Arrange
      user = User.create!(email: 'exemplo@mail.com', password: 'password')
